...
------------------------------------------------------------''')
  while True:
      ...
      while PilihanMenuKaryawan == '1':
        InputNomorKaryawan = int(input("\nSilakan masukkan Nomor Karyawan Anda: "))
          
        DataCheck = None
        for i in DatabaseKaryawan:
          if i["Nomor Karyawan"] == InputNomorKaryawan:
              DataCheck = i
...
------------------------------------------------------------''')
    ...
    while PilihanMenuAdmin == '1':
        NomorKaryawanBaru = int(input("Masukkan nomor karyawan baru yang ingin ditambahkan: "))

        DataCheck = None
        for i in DatabaseKaryawan:
            if i["Nomor Karyawan"] == NomorKaryawanBaru:
                DataCheck = i
        ...
        if DataCheck is not None:
            ...
            KonfirmasiTambahanData = input("Apakah Anda yakin ingin menambahkan database karyawan ini (Y/N)? ")
    ...
    while True:
        ...
        while PilihanMenuAdmin == '1':
            ...
            if DataCheck == None:
                ...
                HapusData = input(f"Apakah Anda yakin ingin menghapus data Karyawan {DataCheck['Name']} (Y/N)? ")
                if HapusData == 'Y':
                ...
                DeleteDataAdmin()
        while PilihanMenuAdmin == '2':
            HapusData = input(f"Apakah Anda yakin ingin menghapus seluruh data Karyawan (Y/N)? ")
            if HapusData == 'Y':
...
# ************ MAIN MENU *****************
def MainMenuAdmin():       
    StatusMenuAdmin = True  
    UserIDAdmin = '1234'
    while StatusMenuAdmin == True:
...
------------------------------------------------------------''')
            ...
            while True:
                PilihanMenu = input ("Apakah Anda ingin ulangi? (Y/N): ")
                if PilihanMenu == "Y":
                  MainMenuAdmin()
                elif PilihanMenu == "N": 
                    MainMenuGeneral()
